...
class DataHelper
{
    ...
    public function getSalesChannel(
        ...
        $result = $salesChannelRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getSalutation(string $salutationKey = 'not_specified'): ?SalutationEntity
    {
        ...
        $result = $salutationRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getCountry(?string $iso3 = null): ?CountryEntity
    {
        ...
        $result = $countryRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getLocale(string $code): ?LocaleEntity
    {
        ...
        $result = $localeRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getLanguage(string $name): ?LanguageEntity
    {
        ...
        $result = $languageRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getCurrency(string $isoCode = 'EUR'): ?CurrencyEntity
    {
        ...
        $result = $currencyRepository->search($criteria, Context::createDefaultContext());
    ...
    public function getTax(float $taxRate): ?TaxEntity
    {
        ...
        $result = $taxRepository->search($criteria, Context::createDefaultContext());
